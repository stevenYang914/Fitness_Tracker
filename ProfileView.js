  ...
  render() {
    return (
      ...
      >
        ...
        <TextInput
          accessible={true}
          accessibilityLabel="Your daily activity duration goal is"
          style={styles.input}
          underlineColorAndroid="transparent"
          placeholder="60"
          placeholderTextColor="#d9bebd"
        ...
        <View style={styles.bottomButtons}>
          ...
          <TouchableOpacity
            accessible={true}
            accessibilityLabel="This is the Save Profile button"
            accessibilityHint="Double tap to finish editing your profile and save changes you made!"
            onPress={() => this.handleSaveProfile()}
          >
            <View>
              <Text style={[styles.buttonInline, {color: "#942a21", fontSize:19}]}> Save Profile </Text>
            </View>
          </TouchableOpacity>
        </View>
        <View style={styles.space} />
