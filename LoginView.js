      ...
      <View style={styles.container}>
        ...
        <View style={{ flexDirection: "row", flexWrap: "wrap" }}>
          ...
          <TouchableOpacity
            ...
            accessibilityHint="Navigates to your today view"
            onPress={this.handleLogin}
          >
            <View>
              <Text style={[styles.buttonInline, {color: "#942a21", fontSize:20}]}> Login</Text>
            </View>
          </TouchableOpacity>
          ...
          <TouchableOpacity
            accessible={true}
            accessibilityLabel="This is the Sign up button"
            accessibilityHint="Double tap to navigates to the sign up view to create your account"
            onPress={this.handleSignup}
          >
            <View>
              <Text style={[styles.buttonInline, {color: "#942a21", fontSize:19}]}> Signup</Text>
            </View>
          </TouchableOpacity>
        </View>
      </View>
